...
def access_file():
    ...
    try:
        ...
        select search_topic,title,description,link from pivot where scrape_id='{id}' '''
        cursor.execute(query)
        data=cursor.fetchall()
        df=pd.DataFrame(data,columns=['Search_query','Title','Description','Link'])
        ...
        folder=f"C:\\Users\\aakan\\OneDrive\\Desktop\\flask\\files\\{id}_google"
